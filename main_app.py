...
if not available_models:
    st.warning(" No local Ollama models found. Please start the Ollama server.")
...
if uploaded_pdf and selected_model:
    ...
    if st.button("Ask AI") and user_query:
        if not is_question_related(user_query, pdf_text_chunks):
            st.warning(" Your question doesn't seem to relate to the uploaded PDF content. Try asking something else.")
        else:
